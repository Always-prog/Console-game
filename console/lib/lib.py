...
class Game():
    def __init__(self,
        ...
        self.CHAT = [
            {"player_name":"Stepan",
             "text":"I am stepan, hello"},
            {
                "player_name":"Vladimir",
                "text":"I am Vladimir, hehe :) "
            },
            {
                "player_name":"Stepan",
                "text":"Ok (="
...
#
    ...
    def UpdateAndDrawChat(self):
        print("\n")
        print("++++")
        for message in self.CHAT[-4:]:
            print(f'{message.get("player_name","unknown")}: {message.get("text","")}')
        print("----")
    ...
    def DrawAll(self):
        ...
        for line_words in self.OUTPUT_IMAGE:
            for word in line_words:
                print(word, end="")
            print("\n", end="")
        self.UpdateAndDrawChat()  # update chat
        self.OUTPUT_IMAGE = [
            [" ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " "," ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " "],
            [" ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " "," ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " "],
            [" ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " "," ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " "],
